    ...
    _circularProgress.prototype.draw = function (targetValue) {
        ...
        if (this.animate) {
            ...
            if (this.targetValue >= this.value) {
                this.clear();
                drawBackground(ctx, _extends({}, _circularProgress.styles['default'].background, style.background), canvasWidth, canvasHeight, function () {
                    drawRing(ctx, canvasWidth, canvasHeight, _extends({}, _circularProgress.styles['default'].ring, style.ring));
                    if (value !== void 0) {
                        drawText(ctx, formatText(value), _extends({}, _circularProgress.styles['default'].text, style.text), canvasWidth, canvasHeight);
                        drawProgress(ctx, +parseFloat(value).toFixed(0), _extends({}, _circularProgress.styles['default'].progress, style.progress), canvasWidth, canvasHeight);
                    }
                });
            } else {
            ...
            drawBackground(ctx, _extends({}, _circularProgress.styles['default'].background, style.background), canvasWidth, canvasHeight, function () {
                ...
                if (targetValue !== void 0) {
                    drawText(ctx, formatText(targetValue), _extends({}, _circularProgress.styles['default'].text, style.text), canvasWidth, canvasHeight);
                    drawProgress(ctx, +parseFloat(targetValue).toFixed(0), _extends({}, _circularProgress.styles['default'].progress, style.progress), canvasWidth, canvasHeight);
                }
            });
        }
